  ...
  return (
    <div
      ...
      <div id='banner-title' className='flex flex-col absolute top-10 left-10'>
        ...
        <div className='text-xs text-gray-600  dark:text-gray-200'>{siteConfig('HEO_HERO_TITLE_3', null, CONFIG)}</div>
      </div>
      ...
      <div
        ...
        <div className='ml-12 -translate-x-32 group-hover:translate-x-0 duration-300 transition-all ease-in'>
          <div className='text-7xl text-white font-extrabold'>Browse Around</div>
  ...
  return (
    <div
      ...
      <div
        ...
        className={`${
          isCoverUp ? 'opacity-100 cursor-pointer' : 'opacity-0 transform scale-110 pointer-events-none'
