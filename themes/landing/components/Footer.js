    ...
    <footer>
      <div className='max-w-6xl mx-auto px-4 sm:px-6'>
        ...
        <div className='grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200'>
          ...
          {/* 4th block */}
          <div className='sm:col-span-6 md:col-span-3 lg:col-span-2'>
            <h6 className='text-gray-800 font-medium mb-2'>"Enterprise"</h6>
            <ul className='text-sm'>
              <li className='mb-2'>
                <a href='#0' className='text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out'>
                  "Homepage"
              ...
              <li className='mb-2'>
                <a
                  href='https://mindset.onthewifi.com/about'
                  className='text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out'>
                  "About Us"
                </a>
              </li>
              ...
              <li className='mb-2'>
                <a
                  href='https://mindset.onthewifi.com/privacy-policy'
                  className='text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out'>
                  "Privacy Policy"
                </a>
              </li>
          ...
          <ul className='flex mb-4 md:order-1 md:ml-4 md:mb-0'>
            <li>
              <div className='h-full flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100'>
                Powered by
                <a href='https://github.com/tangly1024/NotionNext' className='mx-1 hover:underline font-semibold'>
