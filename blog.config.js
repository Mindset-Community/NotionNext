...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    'en:91ce815862804ea096ba5f9e647b21c5,tr:7ff46bf4c57f4075b6b6c921f5cf6db4,ru:0c57f0e348a245d184bfeef751129a18',
  ...
  GREETING_WORDS:
    ...
    'Latest Community Updates, Latest News Posts, Welcome to Mindset Mastery',
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,email,facebook,reddit,twitter,whatsapp,telegram,messenger,linkedin,vkshare,tumblr,line,wechat,qq,weibo', // 分享的服務，按顺序显示,逗号隔开
  ...
  ANALYTICS_GOOGLE_ID:
    process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-09RMV566WX', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  SEO_GOOGLE_SITE_VERIFICATION:
    ...
    'pxEJg6wmQSj2lZomf8vnR4RTs3qQKQWg5pXtB_IvXKw', // Remove the value or replace it with your own google site verification code
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'pub-8437419081527400', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
  ...
  ADSENSE_GOOGLE_SLOT_IN_ARTICLE:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_IN_ARTICLE || '7996388320', // Google AdScene>广告>按单元广告>新建文章内嵌广告 粘贴html代码中的data-ad-slot值
  ADSENSE_GOOGLE_SLOT_FLOW:
    process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_FLOW || '1520525602', // Google AdScene>广告>按单元广告>新建信息流广告
  ...
  MAILCHIMP_API_KEY:
    process.env.MAILCHIMP_API_KEY || '9a6589f16828134680234b85fe1a7471-us22', // 开启mailichimp邮件订阅 APIkey
  ...
  DESCRIPTION:
    ...
    'Finance | Health & Wellness | Business | Commerce ', // 站点描述，被notion中的页面描述覆盖
